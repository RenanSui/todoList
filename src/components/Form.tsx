...
const Form = ({ setList }: any) => {
    ...
    return (
        <form className="flex font-josefin shadow-xl duration-300 transition-all" onSubmit={handleSubmit}>
            <label className="hidden">Todo</label>
            <button className="flex cursor-pointer items-center rounded-l-md bg-[#24273D]">
                <span className="relative my-4 mx-4 sm:mx-7 inline-block h-7 w-7 rounded-full border border-solid border-[#a4aad84d] text-[#a4aad8] sm:my-7 sm:h-10 sm:w-10">
