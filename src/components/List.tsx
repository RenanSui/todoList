                ...
                editing && editingId == item.id ? (
                    ...
                    >
                        <button className="flex cursor-pointer items-center">
                            <span className="relative mx-4 inline-block h-7 w-7 rounded-full border border-solid border-[#a4aad84d] bg-[#a4aad819] text-[#a4aad8] sm:mx-7 sm:h-10 sm:w-10">
                                <p className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 text-[#a4aad8]"></p>
                            </span>
                        </button>
                        <input
                            autoFocus
                            ...
                            className=" my-5 w-full rounded-r-md bg-[#39243d] text-[#a4aad8] outline-none placeholder:text-sm placeholder:tracking-widest placeholder:text-[#a4aad8] sm:my-8 sm:placeholder:text-base"
                        />
